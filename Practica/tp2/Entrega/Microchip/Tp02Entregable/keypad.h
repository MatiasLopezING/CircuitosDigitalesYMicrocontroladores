/**
 * 
 *  Librería para el escaneo matricial de un teclado 4x4.
 * 
...
/**
 *  Inicializa los pines del microcontrolador conectados al teclado.
...
/**
 *  Escanea la matriz del teclado para detectar pulsaciones.
 * @param pkey Puntero que tiene la direccion donde se almacenará el código ASCII de la tecla detectada.
 * @return 1 si se detectó una nueva tecla presionada, 0 en caso contrario.
 */
uint8_t KEYPAD_Scan(uint8_t *pkey);

/**
 *  Función auxiliar que escanea el teclado y devuelve el caracter directamente.
